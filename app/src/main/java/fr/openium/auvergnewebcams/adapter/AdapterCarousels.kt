 ...
 */
class AdapterCarousels(val context: Context, val listener: ((Webcam, Int) -> Unit)? = null, var items: List<Section>, val composites: CompositeDisposable, val listenerSectionClick: ((Section) -> Unit)) : RecyclerView.Adapter<AdapterCarousels.WebcamHolder>() {
