...
import fr.openium.auvergnewebcams.carousel.util.ScrollListenerAdapter;
...
public class DiscreteScrollView extends RecyclerView {
    ...
    private void init(AttributeSet attrs) {
        ...
        layoutManager = new DiscreteScrollLayoutManager(
                ...
                fr.openium.auvergnewebcams.carousel.Orientation.values()[orientation]);
    ...
    public void setOrientation(fr.openium.auvergnewebcams.carousel.Orientation orientation) {
